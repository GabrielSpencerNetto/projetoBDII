...
public class ConsultaVenda extends JFrame{
    ...
    Orders orderConsulta = new Orders();
    ...
    public void configuraTela(){
        ...
        orderConsulta = controllerOrders.consultar(inputValue);
        if(orderConsulta==null){
        ...
        inicializaBotoes();
        inicializaCampos();
        //obtemClienteConsultar(orderConsulta);
    ...
    public void inicializaCampos(){
        ...
        textOrderID.setText(Integer.toString(orderConsulta.OrderID));
        ...
        textOrderDate.setText(dateFormat.format(orderConsulta.OrderDate));
        ...
        textRequiredDate.setText(dateFormat.format(orderConsulta.RequiredDate));
        ...
        textShippedDate.setText(dateFormat.format(orderConsulta.ShippedDate));
        ...
        textFreigth.setText(Double.toString(orderConsulta.Freigth));
        ...
        textShipName.setText(orderConsulta.ShipName);
        ...
        textShipAddress.setText(orderConsulta.ShipAddress);
        ...
        textShipCity.setText(orderConsulta.ShipCity);
        ...
        textShipRegion.setText(orderConsulta.ShipRegion);
        ...
        textShipPostalCode.setText(orderConsulta.ShipPostalCode);
        ...
        textCountry.setText(orderConsulta.ShipCountry);
